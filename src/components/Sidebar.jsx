        ...
        <div className={openSidebar ? "sb" : "closed-sb"}>
            ...
            <nav className="sb-nav">
                {sections.map((sec) => (
                    <div key={sec.sec} className="sb-sec">
                        <div className="sb-sl">{openSidebar && sec.sec}</div>
                        {sec.items.map((it) => (
            ...
            <div className="sb-foot">
                ...
                <div className={openSidebar ? "sb-user" : "sb-user-off"}>
                    ...
                    {roles && (
                        <div className={openSidebar ? "natifications" : "number"} onClick={openSidebar && NextOpening_2} style={{display: checked_complains.length > 0 ? null : "none" }}>{openSidebar && "🔔"}
                ...
                {user.role === "direktor" && <div className="complain" onClick={NextOpening}>⚠️ {openSidebar && "Shikoyat qilish"}</div>}
                {show && (
