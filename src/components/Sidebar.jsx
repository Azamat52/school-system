...
export default function Sidebar({user, page, setPage, onLogout, theme, onToggleTheme, admins, teachers, students, setComplains }) {
        ...
        <div className="sb">
            ...
            <div className="sb-foot">
                ...
                <div className="sb-user">
                    ...
                    {role && (
                        <div className="natifications" onClick={() => setShow2(true)}>🔔
                            <p className="checking-complain"></p>
                        </div>)}
                </div>
                            ...
                            {quickList.length > 0 ? <div className="hints divs hidden" style={{marginBottom: "25px", maxHeight: "220px", overflowY: "auto"}}>
                                ...
                                {quickList.map((x, i) => (
                                    <div className="fi name"
                                         onClick={() => setName(x.name)}>{x.length === 0 ? "Ma'lumot topilmadi 🔎" : `${i + 1} - ${x.name} Huquq(${roleLabel[x.role]})`}</div>
                                ))}
                            </div> : <div className="hints" style={{marginBottom: "25px"}}>Ma'lumot topilmadi</div>}
                            <form className="fl">
